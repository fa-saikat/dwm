...
static const char *defaulttagapps[]    = { NULL, "kitty", "firefox", "kate", "dolphin", "qbittorrent", "btop" };
...
static const char *kruncmd[]  = { "krunner", NULL };
...
{ MODKEY|ShiftMask,             XK_b,             setlayout,       { .v = &layouts[2]} },   /* Bottomstack */
...
//{ MODKEY|Mod1Mask,  XK_,             setlayout,       { .v = &layouts[3]} },               /* Spiral */
